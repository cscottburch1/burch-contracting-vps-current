...
export const metadata: Metadata = {
  ...
  description:
    'Estimate deck and screened porch costs with local installed pricing for pressure-treated, composite, and covered outdoor living projects in Simpsonville, Fountain Inn & Greenville County.',
...
export default function DecksAndPorchesCalculatorPage() {
  const breadcrumbs = [
    ...
    { label: 'Decks & Screened Porches Calculator', href: '/calculator/decks-screened-porches' },
  ];
  ...
  return (
    <>
      ...
      <UniversalPageTemplate
        title="Deck and Screened Porch Cost Calculator - Simpsonville & Upstate SC"
        breadcrumbs={breadcrumbs}
        showAuthor={true}
        author={{
          name: 'C. Scott Burch',
          role: 'Owner & Lead Carpenter',
          experience: '35+ years | 87 decks & 50+ porches built',
        }}
        showCredentials={true}
        credentialsVariant="compact"
        lastUpdated={new Date('2026-04-17')}
        relatedPages={[
          { title: 'Custom Decks', href: '/deck-builder', description: 'Professional deck construction' },
      ...
      >
        <ProjectCostCalculator
          ...
          disclaimer="Outdoor living project estimates include 22.5% overhead and profit for site supervision and warranty coverage. Final costs depend on ground conditions, required footings depth, deck board material selection (pressure-treated vs composite), railing system complexity, stair configuration, permit requirements, and existing structure attachments. Site-specific factors like slope and access affect labor hours significantly."
          options={[
            {
