        ...
        {showInstallButton && (
          <div className="mt-5">
            <button
              ...
              className="w-full bg-gradient-to-r from-green-600 to-green-700 text-white py-4 rounded-xl font-bold text-base shadow-lg hover:shadow-xl hover:from-green-700 hover:to-green-800 active:scale-[0.98] transition-all flex items-center justify-center gap-2"
            >
